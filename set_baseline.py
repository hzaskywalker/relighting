...
from network2 import UnetExtractor, RelightNet, expand_ws, FixedMaskDirector
...
def main():
    ...
    director = FixedMaskDirector(len(light), args.num_sample).cuda()
    ...
    for epoch_id in range(start_epoch+1, args.num_epochs):
        ...
        for batch_id in tqdm.trange(num_batchs):
            ...
            masks = torch.stack(masks, dim=1).detach()
